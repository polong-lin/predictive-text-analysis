if(file.exists("predictive-text-analysis/emoticonlist.rds")==FALSE){
    library(RCurl)
    library(httr)
    library(XML)
    ...
    #saveRDS
    saveRDS(emoticonlist, file = "predictive-text-analysis/emoticonlist.rds")
    ...
    emoticonlist <- readRDS("predictive-text-analysis/emoticonlist.rds")
}
